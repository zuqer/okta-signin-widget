/*! THIS FILE IS GENERATED FROM PACKAGE @okta/courage@4.6.0-alpha.2049.g294997b */
module.exports =
...
/* harmony default export */ __webpack_exports__["default"] = ({
  ...
  convertToPDT: function (milliseconds, formatter, defaultText) {
    ...
    return milliseconds
      ? Object(__WEBPACK_IMPORTED_MODULE_0__moment_wrapper__["a" /* default */])(milliseconds)
        .utc()
        .utcOffset('-07:00')
        .format(formatter)
      : defaultText;
  ...
  getTimeInHighestRelevantUnit: function (val, unit) {
    const duration = __WEBPACK_IMPORTED_MODULE_0__moment_wrapper__["a" /* default */].duration(val, MOMENT_UNIT[unit] || unit);
    let highestUnit;
  ...
  convertTimeUnit: function (val, fromUnit, toUnit) {
    ...
    return __WEBPACK_IMPORTED_MODULE_0__moment_wrapper__["a" /* default */].duration(val, fromUnit).as(toUnit);
  },
  ...
  convertTimeFormat: function (timeString, fromFormatter, toFormatter) {
    ...
    return Object(__WEBPACK_IMPORTED_MODULE_0__moment_wrapper__["a" /* default */])(timeString, fromFormatter).format(toFormatter);
  }
});
...
if (typeof okta !== 'undefined' && (okta.locale || 'en')) {
  __WEBPACK_IMPORTED_MODULE_0_moment___default.a.locale(okta.locale || 'en');
}
/* harmony default export */ __webpack_exports__["a"] = (__WEBPACK_IMPORTED_MODULE_0_moment___default.a);
