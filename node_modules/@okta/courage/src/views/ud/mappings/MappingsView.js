...
define([
...
], function (_, BaseView, BaseCollection, TemplateUtil, AppDescriptionView, ModalTabs, MappingsViewContent,
  ...
  return BaseView.extend({
    ...
    _retrieveMapping: function () {
      if (this.model.get('sourceId') && this.model.get('targetId') &&
        ...
        this.model
          ...
          .fail(function () {
            // api returns error when no existing mapping is found
            self.model.set('propertyMappings', []);
    ...
    _getSystemPropertyMappings: function (targetAttributes) {
      ...
      var allMappings = this.model.get('propertyMappings').toJSON(),
          allTargetAttributes = targetAttributes.reduce(function (init, m) {
    ...
    _processMappingData: function () {
      ...
      if (this.model.get('propertyMappings') instanceof BaseCollection) {
