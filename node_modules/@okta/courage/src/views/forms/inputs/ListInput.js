...
define([
...
], function (_, StringUtil, BaseInput, BaseView, BaseCollection, ButtonFactory, ListView) {
  ...
  var InputListView = ListView.extend({
    ...
    _updateElements: function () {
      this.addNewItemButton.toggleVisibility(this._canAddNewItem());
  ...
  return BaseInput.extend({
    ...
    render: function () {
      var collection = this.collection = this.options.collection = new BaseCollection(this.getModelValue());
