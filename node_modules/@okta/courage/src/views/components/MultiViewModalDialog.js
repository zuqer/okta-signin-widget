...
function (_, $, BaseModalDialog, Fx, DialogLoading) {
  ...
  return BaseModalDialog.extend({
    ...
    updateTitle: function (title) {
      ...
      if (title) {
        ...
        if (this.rendered()) {
          ...
          this.currentView.$('h2.o-form-head').remove();
        } else {
     ...
     * @private
     */
    _postPrefetchDetection: function (newView, options, isSwitchView) {
    ...
    _getPrefetchFunction: function (newView, options) {
      ...
      // If prefetch function has defined in view
      } else if (_.isFunction(newView.prefetch)) {
        return newView.prefetch;
      }
    ...
    _prefetchDetection: function (options, isSwitchView) {
      var self = this,
          ...
          callback = _.bind(this._postPrefetchDetection, this, newView, options, isSwitchView),
